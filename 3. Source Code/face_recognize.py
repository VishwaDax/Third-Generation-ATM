...
import random
#DO THE CHANGES HERE
gmail_user = "vishwavengadesh@outlook.com"
gmail_pwd = "SATHISHcse"
FROM = 'vishwavengadesh@outlook.com'
TO = ['vishwavengadesh@outlook.com'] #must be a list
...
def mail():
    ...
    #DO THE CHANGES HERE
    body="THIS is from your ATM  :"+str(otp_)
...
datasets = 'datasets'
n=input("enter your AccountNumber : ")
print('Training...')
